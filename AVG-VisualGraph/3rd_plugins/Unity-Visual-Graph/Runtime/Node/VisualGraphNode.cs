...
namespace VisualGraphRuntime
{
    ...
    public abstract class VisualGraphNode : ScriptableObject
    {
        ...
        /// </summary>
        /// <returns></returns>
        public VisualGraphPort GetOutput1Port()
        {
            return GetOutpotPortWithIndex(0);
        }
        /// <summary>
        /// 获取第2个输出点
        /// </summary>
        /// <returns></returns>
        public VisualGraphPort GetOutput2Port()
        {
            return GetOutpotPortWithIndex(1);
        }
        /// <summary>
        /// 获取第3个输出点
        /// </summary>
        /// <returns></returns>
        public VisualGraphPort GetOutput3Port()
        {
            return GetOutpotPortWithIndex(2);
        }
